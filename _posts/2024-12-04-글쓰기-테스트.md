...
This tutorial will guide you how to write a post in the _Chirpy_ template, and it's worth reading even if you'v used Jekyll before, as many features require specific variables to be set.
